...
int main(int argc, char **argv)
{
 ...
 struct lc_env *env =
					// TODO: Replace this with a static lookup table. possible with a linked list at the bottom for user extended functions/whatever term I am about to get um actuallied with.
					lc_env(lc_tr_ref("print_tr", 8), lc_tr_c_func(lc_c_print_tr),
												lc_env(lc_tr_ref("print_cstr", 10), lc_tr_c_func(lc_c_print_cstr),
																			lc_env(lc_tr_ref("atoi", 4), lc_tr_c_func(lc_c_atoi),
																										lc_env(lc_tr_ref("print_i", 7), lc_tr_c_func(lc_c_print_i),
																																	lc_env(lc_tr_ref("c_inc", 5), lc_tr_c_func(lc_c_inc),
																																								lc_env(lc_tr_ref("c_2n", 4), lc_tr_c_func(lc_c_2n),
																																															NULL))))));
